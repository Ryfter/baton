...
> - `note` — written by `/baton:log-routing` slash command (user/Claude qualitative).
...
>
> Consolidation (`/baton:consolidate-routing`) reads everything since the last archive
